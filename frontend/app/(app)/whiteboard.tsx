...
export default function WhiteboardScreen() {
  ...
  return <Screen title="Whiteboard" subtitle="Team updates, replies, files, and @Nathan" testID="whiteboard-screen"><View style={styles.mobile}><WhiteboardFeed /></View></Screen>;
}
