...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { key: "whiteboard", label: "Live Feed", route: "/(app)/whiteboard", icon: "chatbubbles-outline", testID: "nav-whiteboard" },
    ],
  },
  {
    key: "operations",
  ...
  },
  {
    ...
    label: "Inventory",
    items: [
      { key: "stiffbacks-inventory", label: "Stiffbacks", route: "/(app)/inventory/stiffbacks", icon: "remove-outline", testID: "nav-inventory-stiffbacks" },
      { key: "turnbuckles-inventory", label: "Turnbuckles", route: "/(app)/inventory/turnbuckles", icon: "sync-outline", testID: "nav-inventory-turnbuckles" },
      { key: "walkboard-brackets-inventory", label: "Walk-Board Brackets", route: "/(app)/inventory/walkboard-brackets", icon: "walk-outline", testID: "nav-inventory-walkboard-brackets" },
      { key: "handrails-inventory", label: "Handrails", route: "/(app)/inventory/handrails", icon: "hand-left-outline", testID: "nav-inventory-handrails" },
      { key: "extensions-inventory", label: "Extensions", route: "/(app)/inventory/extensions", icon: "resize-outline", testID: "nav-inventory-extensions" },
      { key: "crankups-inventory", label: "Crankups", route: "/(app)/inventory/crankups", icon: "trending-up-outline", testID: "nav-inventory-crankups" },
      { key: "shoring-inventory", label: "Shoring", route: "/(app)/inventory/shoring", icon: "shield-outline", testID: "nav-inventory-shoring" },
