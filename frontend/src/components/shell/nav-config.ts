...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "scaffolding-inventory", label: "Crankups/Shoring", route: "/(app)/inventory/scaffolding", icon: "grid-outline", testID: "nav-inventory-scaffolding" },
      ...
      { key: "block-inventory", label: "ICF Block", route: "/(app)/inventory/block", icon: "layers-outline", testID: "nav-inventory-block" },
